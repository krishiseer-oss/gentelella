...
export const NAV = [
  {
    ...
    items: [
      ...
      {
        text: 'Procurement', icon: 'tables',
        children: [
          { key: 'procurement-overview', href: 'procurement_overview.html', text: 'Overview' },
          { key: 'tenders', href: 'tenders.html', text: 'Tenders' },
          { key: 'purchase-orders', href: 'purchase_orders.html', text: 'Purchase Orders' },
          { key: 'gem-procurement', href: 'gem_procurement.html', text: 'GeM Procurement' },
          { key: 'mse-procurement', href: 'mse_procurement.html', text: 'MSE Procurement' }
        ]
      },
      {
        text: 'Vendors', icon: 'users',
        children: [
          { key: 'vendor-directory', href: 'vendor_directory.html', text: 'Vendor Directory' },
          { key: 'vendor-performance', href: 'vendor_performance.html', text: 'Vendor Performance' }
        ]
      },
      {
        text: 'Payments', icon: 'receipt',
        children: [
          { key: 'all-payments', href: 'all_payments.html', text: 'All Payments' },
          { key: 'pending-payments', href: 'pending_payments.html', text: 'Pending Payments' },
          { key: 'paid-payments', href: 'paid_payments.html', text: 'Paid Payments' },
          { key: 'delayed-payments', href: 'delayed_payments.html', text: 'Delayed Payments' }
        ]
      },
      {
        text: 'Analytics', icon: 'charts',
        children: [
          { key: 'procurement-analytics', href: 'procurement_analytics.html', text: 'Procurement Analytics' },
          { key: 'payment-analytics', href: 'payment_analytics.html', text: 'Payment Analytics' },
          { key: 'vendor-analytics', href: 'vendor_analytics.html', text: 'Vendor Analytics' }
        ]
      },
      { key: 'reports', href: 'reports.html', text: 'Reports', icon: 'files' },
      { key: 'documents', href: 'documents.html', text: 'Documents', icon: 'pages' },
      { key: 'audit-logs', href: 'audit_logs.html', text: 'Audit Logs', icon: 'forms' },
